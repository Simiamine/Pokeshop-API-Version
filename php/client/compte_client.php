    ...
    <div class="bg-light border rounded-3 p-3">
        ...
        <div class="container">
            ...
            if (isset($_SESSION['user_id']) && isset($_SESSION['access_token'])) {
                ...
                $url = "http://127.0.0.1:8000/api/utilisateurs/{$user_id}/";
                ...
                if ($httpcode == 200) {
                    ...
                    echo "<p>Votre date de naissance : " . htmlspecialchars($utilisateur['date_naissance']) . "</p>";
                    echo "<p>Votre numéro de téléphone : " . htmlspecialchars($utilisateur['telephone']) . "</p>";
                } else {
                    echo "<p>Erreur lors de la récupération des informations.</p>";
                }
